      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-6">
        ...
        {flowData.clientInfo && (
          <motion.div
            ...
            className="glass-strong rounded-2xl p-6 border-2 border-cyan-400/20 glow-cyan"
          >
            <div className="flex items-center gap-3 mb-4">
              <Eye className="w-5 h-5 text-cyan-400" />
              <h3 className="text-xl font-bold gradient-text">Client Information</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-black/30 rounded-xl p-4">
                ...
                <code className="text-sm text-cyan-400 font-mono font-bold">{flowData.clientInfo.ip}</code>
              </div>
              <div className="bg-black/30 rounded-xl p-4">
                <div className="text-xs text-gray-400 mb-2 flex items-center gap-2">
                ...
                <div className="text-sm text-white font-semibold">{flowData.clientInfo.city}</div>
                <div className="text-xs text-purple-400">{flowData.clientInfo.country}</div>
              </div>
              <div className="bg-black/30 rounded-xl p-4">
                <div className="text-xs text-gray-400 mb-2 flex items-center gap-2">
                ...
                <div className="text-xs text-gray-300">{flowData.clientInfo.asn}</div>
              </div>
              <div className="bg-black/30 rounded-xl p-4">
                <div className="text-xs text-gray-400 mb-2 flex items-center gap-2">
                ...
                <div className="text-xs text-gray-300 truncate" title={flowData.clientInfo.userAgent}>
                  {flowData.clientInfo.userAgent.substring(0, 30)}...
                </div>
              </div>
            </div>
            {/* Request Headers */}
            <div className="mt-4 pt-4 border-t border-white/10">
              <div className="flex items-center justify-between mb-3">
                <h4 className="text-sm font-bold text-purple-300">Request Headers</h4>
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={() => navigator.clipboard.writeText(JSON.stringify(flowData.clientInfo.requestHeaders, null, 2))}
                  className="text-xs px-3 py-1 rounded-lg glass hover:glass-strong flex items-center gap-2"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 max-h-40 overflow-y-auto pr-2">
                {Object.entries(flowData.clientInfo.requestHeaders).map(([key, value]) => (
                  <div key={key} className="flex items-start gap-2 text-xs bg-black/20 rounded px-2 py-1.5">
                    <span className="text-cyan-400 font-mono font-semibold">{key}:</span>
